...
type Job struct {
	...
	Command  string `json:"command"`  //sell命令
...
type JobLog struct {
	...
	EndTime      int64  `bson:"endTime"`      //任务实行结束时间
}
...
//从etcd的key中提取任务名
//从 /cron/jobs/job10抹掉/crom/jobs/
func ExtractJobName(jobKey string) string {
	return strings.TrimPrefix(jobKey, JOB_SAVE_DIR)
}

//从etcd的key中提取任务名
//从 /cron/killer/job10抹掉/crom/killer/
